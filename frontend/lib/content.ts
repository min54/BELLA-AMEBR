...
export const content: Record<Language, LocalizedContent> = {
  KR: {
    ...
    formSns: "SNS 계정 (Instagram / TikTok / YouTube)",
    formSnsPlaceholder: "@username 또는 유튜브 채널 URL",
    formEmail: "이메일",
  ...
  JP: {
    ...
    formSns: "SNSアカウント (Instagram / TikTok / YouTube)",
    formSnsPlaceholder: "@username またはYouTubeチャンネルURL",
    formEmail: "メールアドレス",
    formEmailPlaceholder: "example@email.com",
    formReason: "志望動機",
